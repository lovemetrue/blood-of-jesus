...
export const SEO_BY_PATH: Record<string, PageSEO> = {
  ...
  "/contacts": {
    title: "Контакты | Кровь и вода",
    description:
      "Свяжитесь с нами. Форма обратной связи, телефон, email. Служение «Кровь и вода».",
  },
  "/payment/success": {
  ...
  "/materials/guides": {
    title: "Руководства | Кровь и вода",
    description:
      "Руководство по освобождению: духовная война, демонические скопления. Скачать материалы служения.",
  },
  "/materials/prayers": {
    title: "Молитвы | Кровь и вода",
    description:
      "Молитвы из небесных залов суда. Небесная юрисдикция, аннулирование злых алтарей. Скачать материалы.",
  },
  "/materials/testimonies": {
    title: "Свидетельства | Кровь и вода",
    description:
      "Свидетельства исцеления и освобождения. Служение «Кровь и вода».",
  },
};
