  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p>
            Мы с супругой возглавляем Служение освобождения в церкви: «Миссия Благая Весть», а также являемся лидерами команды жизни от JGLM — John G. Lake Ministries.
          ...
          <ul className="list-disc list-inside space-y-1.5 pl-2">
            ...
            <li>Крестить водой и Святым Духом.</li>
          </ul>
        </motion.div>
      </div>
    </motion.section>
