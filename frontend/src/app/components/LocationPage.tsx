...
export function LocationPage({ onBack }: { onBack: () => void }) {
  useEffect(() => {
    ...
    const structuredData = {
      ...
      "@type": "LocalBusiness",
      "name": "Служение освобождения: Кровь Христа",
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl shadow-red-900/10 p-6 sm:p-8 lg:p-12 border-2 border-gray-800 space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-4">
                  Наше Служение освобождения распространяется на всю территорию Российской Федерации. 
                ...
                <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
                  ...
                  достигаем верующих по всей стране, помогая им обрести свободу и 
                  исцеление во Христе.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-4">
                  Санкт-Петербург является основным центром Служения освобождения. Здесь 
          ...
          <div className="mt-8 pt-8 border-t border-gray-700">
            ...
            <div className="text-gray-300 text-base sm:text-lg leading-relaxed space-y-4">
              <p>
                Служение освобождения и исцеления доступно для всех жителей 
