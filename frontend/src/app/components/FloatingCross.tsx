    ...
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      >
        <div className="relative w-8 h-8 opacity-10">
          <div className="absolute left-1/2 top-0 w-1 h-8 bg-[#DC143C] transform -translate-x-1/2 rounded-full" />
          <div className="absolute top-1/3 left-[4px] right-[4px] h-1 bg-[#DC143C] transform -translate-y-1/2 rounded-full" />
        </div>
      </motion.div>
      ...
      >
        <div className="relative w-11 h-11 opacity-10">
          <div className="absolute left-1/2 top-0 w-1.5 h-11 bg-[#DC143C] transform -translate-x-1/2 rounded-full" />
          <div className="absolute top-1/3 left-[5px] right-[5px] h-1.5 bg-[#DC143C] transform -translate-y-1/2 rounded-full" />
        </div>
      </motion.div>
      ...
      >
        <div className="relative w-7 h-7 opacity-10">
          <div className="absolute left-1/2 top-0 w-1 h-7 bg-[#FF1744] transform -translate-x-1/2 rounded-full" />
          <div className="absolute top-1/3 left-[4px] right-[4px] h-1 bg-[#FF1744] transform -translate-y-1/2 rounded-full" />
        </div>
      </motion.div>
      ...
      >
        <div className="relative w-10 h-10 opacity-10">
          <div className="absolute left-1/2 top-0 w-1 h-10 bg-[#DC143C] transform -translate-x-1/2 rounded-full" />
          <div className="absolute top-1/3 left-[4px] right-[4px] h-1 bg-[#DC143C] transform -translate-y-1/2 rounded-full" />
        </div>
      </motion.div>
      ...
      >
        <div className="relative w-8 h-8 opacity-10">
          <div className="absolute left-1/2 top-0 w-1 h-8 bg-[#FF1744] transform -translate-x-1/2 rounded-full" />
          <div className="absolute top-1/3 left-[4px] right-[4px] h-1 bg-[#FF1744] transform -translate-y-1/2 rounded-full" />
        </div>
      </motion.div>
    </div>
