...
const testimonies: Testimony[] = [
  {
    ...
    preview:
      "На молитвенном собрании женщина рассказала о сколиозе, диагностированном примерно с 4 лет. После короткой молитвы и изгнания духа змеи спина выпрямилась — врач позже подтвердил почти полное исцеление.",
    paragraphs: [
      "Однажды на молитвенном собрании в нашей церкви женщина рассказала о том, что примерно с 4-х лет ей диагностировали сколиоз.",
      ...
      "Позже врач подтвердил, что спина выпрямилась почти на 100%. Примерно 90% искривления было демоническим влиянием змееподобного духа, который маскировался под диагноз сколиоза около 40 лет. Врачи прогнозировали ей горб.",
      "Но была явлена слава Бога, и она была освобождена и исцелена чудесным образом. Вся слава, хвала и честь Иисусу Христу.",
    ],
  },
  {
