...
import { staggerContainer, staggerItem, viewportOnce } from "@/app/motionVariants";
...
const testimonies: Testimony[] = [
  {
    ...
    preview:
      "На молитвенном собрании женщина, много лет страдавшая сколиозом, получила освобождение после короткой молитвы. Уже в тот же день окружающие увидели изменения, а позже врач подтвердил выпрямление спины.",
    paragraphs: [
