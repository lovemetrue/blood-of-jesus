...
export function SEOHead({
  ...
  description = 'Служение освобождения, изгнания демонов и исцеления души через веру и власть в Иисусе Христе. Бесплатные материалы, проповеди и молитвы для вашего духовного роста.',
  keywords = 'головная боль, боль в спине, мигреньизгнание демонов, исцеление души, Иисус Христос, молитвы освобождения, духовная война, христианское служение, вера во Христе, духовная свобода, избавление от угнетения',
