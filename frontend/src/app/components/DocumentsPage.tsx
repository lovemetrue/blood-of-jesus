            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="text-gray-300 space-y-6 text-sm sm:text-base leading-relaxed">
                <div>
                  ...
                  <p className="mb-3">
                    Служение: «Кровь Христа» активно работает по всей территории Российской Федерации, 
                  ...
                  <p>
                    Наше Служение освобождения направлено на то, чтобы каждый человек в России мог узнать о 
