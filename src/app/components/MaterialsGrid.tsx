        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {materials.map((material) => {
            ...
            return (
              <article
                key={material.id}
                className="bg-gray-900/50 backdrop-blur-sm border-2 border-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:border-[#DC143C] hover:shadow-xl hover:shadow-red-900/20 transition-all duration-300 group"
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 text-sm sm:text-base bg-[#DC143C] text-white rounded-lg hover:bg-[#FF1744] transition-colors shadow-lg shadow-red-900/30"
