...
export const SEO_BY_PATH: Record<string, PageSEO> = {
  "/": {
    ...
    description:
      "Иисус целитель. Служение освобождения и исцеления души через веру во Христа. Молитвы об освобождении, как правильно молиться. Материалы о мигрени, депрессии, бессоннице. Бесплатные материалы и заветы.",
  },
  "/documents": {
